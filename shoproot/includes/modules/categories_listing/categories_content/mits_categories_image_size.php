...
if ((defined('MODULE_PRODUCT_MITS_IMAGESIZE_STATUS')
  ...
  && isset($rows)
    ...
    $categories_content[$rows]['CATEGORIES_IMAGE_SIZE'] = $cat_image_attr['default'];
    $categories_content[$rows]['CATEGORIES_IMAGE_LIST_SIZE'] = $cat_image_attr['list'];
    $categories_content[$rows]['CATEGORIES_IMAGE_MOBILE_SIZE'] = $cat_image_attr['mobile'];
}
